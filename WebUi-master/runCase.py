...
if __name__ == '__main__':
      ...
      if result == 1:
            #截图文件的路径
            imPath = os.path.join(path, 'WebUi-master','result','image')
            #日志文件的路径
            logPath = os.path.join(path, 'WebUi-master','result','logs')
            #测试报告的路径
            reportPath = os.path.join(path, 'WebUi-master','result','report')
